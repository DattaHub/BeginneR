...
`names(oscars)` or `colnames(oscars)` to remind yourself of the column names. For instance, to extract all the oscar winners' age at the time of win information from our dataset:
