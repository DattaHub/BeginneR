...
> ### Challenge 
1.   Read the American Community Survey Data (2012) from [https://www.openintro.org/data/index.php?data=acs12](https://www.openintro.org/data/index.php?data=acs12). Use the `read.csv` function taught before. 2.   Look at the structure of the data-set by using the `str` function. 
3.   Calculate the mean annual income (`income`) by gender (`gender`) and birth quarter (`birth_qrtr`).
4.   What other variables could be of interest? 
