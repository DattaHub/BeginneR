...
description: >
  We will start with a few basic pointers about R programming. We will talk   about concept of an `R` object, how to assign values to objects and the    fundamental idea of vectors and data types in R, and see basic functions. 
---
